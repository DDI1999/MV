...
class CameraOperation():
    ...
    def __init__(self, obj_cam, st_device_list, n_connect_num=0, b_open_device=False, b_start_grabbing=False,
                 ...
                 buf_save_image=None, \
                 n_save_image_size=0, n_win_gui_id=0, frame_rate=0, exposure_time=0, gain=0, width=0, height=0,
                 offsetx=0, offsety=0, nPayloadSize=0):
    ...
    def Get_parameter(self):
        if True == self.b_open_device:
            ...
            c_frame = self.To_hex_str(
                self.obj_cam.MV_CC_GetFloatValue("AcquisitionFrameRate", stFloatParam_FrameRate))  # 帧率
            # ResultingFrameRate
