...
from open_camera_gui import Ui_MainWindow  # 导入创建的GUI类
import sys
import threading
import msvcrt
from ctypes import *
...
class mywindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def image_control(self, data, stFrameInfo):
        if stFrameInfo.enPixelType == 17301514:
            data = data.reshape((stFrameInfo.nHeight, stFrameInfo.nWidth, -1))
            return cv2.cvtColor(data, cv2.COLOR_BayerGB2RGB)
